...
def process_next_20_files():
    ...
    """
    files_to_process = [
        "Digital Marketing Basics for an Entrepreneur.md",
        "Digital Marketing Handbook for Micro and Small Businesses.md",
        "Digital Marketing.md",
        "Digital Purchase Paths and Online Store Planning.md",
        "DNA Digitaalinen elämä 2024_open päivitetty.md",
        "DNA Digital Life 2024 Research Report.md",
        "DNA Digital Life 2024 Updated.md",
        "Elements of Good Advertising and Ideation Tools.md",
        "elo vinkit vanhempainvapaa 040920.md",
        "Entrepreneur's Risk Management.md",
        "Ergonomia, työhyvinvointi ja työturvallisuus.md",
        "Ergonomics Workplace Well-being and Occupational Safety.md",
        "esihenkilöiden lainsäädäntö.md",
        "Esimerkki markkinoinnin vuosikello.md",
        "Establishing a Company and Establishment Notification to the Trade Register.md",
        "Example Articles of Association Partnership Agreement and Bylaws in the YTJ Service.md",
        "Example Limited Liability Company Articles of Association.md",
        "Example Partnership Agreement for a Limited Partnership.md",
        "Example Partnership Agreement for an Open Company.md",
        "Example Partnership Agreement.md"
    ]
