"""
Python implementation of YT4_Taloussuunnitelma_BusinessOulu financial planning template.

This module provides programmatic access to the financial planning functionality
originally implemented in the YT4_Taloussuunnitelma_BusinessOulu.xlsx spreadsheet.
"""
...
class FinancialPlanBusinessOulu:
    """
    A class representing a comprehensive financial plan based on the YT4_Taloussuunnitelma_BusinessOulu template.
    """
    
    def __init__(self, company_name: str = "BusinessOulu", start_year: int = 2026):
...
def create_sample_plan() -> FinancialPlanBusinessOulu:
    """Create a sample financial plan with example data for BusinessOulu."""
    plan = FinancialPlanBusinessOulu(company_name="Sample BusinessOulu Oy", start_year=2026)
    
    # Set some example investment needs
    plan.set_investment_need("premises_and_connection_fees", 12000)
    plan.set_investment_need("machines_equipment", 18000)
    plan.set_investment_need("working_capital", 6000)
    
    # Set some example funding
    plan.set_funding_source("long_term_loans", 10000, "BusinessOulu Bank", 3.2, 5, 6000)
    plan.set_funding_source("own_funding", 15000)
    plan.set_funding_source("business_grants", 7000)
    ...
    # Set operating costs
    plan.set_operating_cost("entrepreneur_compensation_yel", "monthly_salary_total", 3200)
    plan.set_operating_cost("employee_salaries_tyel", "monthly_salary_total", 2200)
...
if __name__ == "__main__":
    # Example usage
    print("YT4 Taloussuunnitelma BusinessOulu - Financial Planning Tool")
    print("=" * 60)
    ...
    sample_plan.save_to_json("sample_financial_plan_businessoulu.json")
    print("\nFinancial plan saved to 'sample_financial_plan_businessoulu.json'")