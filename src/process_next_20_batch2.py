...
def process_next_20_files():
    ...
    """
    files_to_process = [
        "Canva Assignments.md",
        "Canva tehtävät.md",
        "Checklist Portfolio and Networking.md",
        "Clarifying the Business Idea Guide and Form.md",
        "Closing a Company and Notification of Cessation to the Trade Register.md",
        "Commercial Premises Lease Agreement Template.md",
        "Commission Agreement Template.md",
        "Company Change Notification to the Trade Register.md",
        "Company's Line of Business in the Trade Register.md",
        "Comparison Business Forms and Taxation 2025.md",
        "Computer User AB Card Qualification Content and Objectives.md",
        "Creditor's Objection to Publication in the Trade Register.md",
        "Customer Commitment Principles and Examples.md",
        "DNA Digital Life 2024 Research Report.md",
        "DNA Digital Life 2024 Updated.md",
        "Digitaalinen markkinointi.md",
        "Digitaalinen ympäristöni.md",
        "Digitaalisen markkinoinnin käsikirja mikro- ja pk-yritykselle.md",
        "Digitaaliset ostopolut.md",
        "Digitaalisuus vihreä logistiikka.md"
    ]
