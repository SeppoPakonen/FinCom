...
def main():
    ...
    # Set additional product properties directly in the product dictionary
    calc.products["example_product"]["target_margin"] = 0.30  # 30% target margin
    calc.products["example_product"]["estimated_volume"] = 1000
    calc.products["example_product"]["competitor_price"] = 75.0
