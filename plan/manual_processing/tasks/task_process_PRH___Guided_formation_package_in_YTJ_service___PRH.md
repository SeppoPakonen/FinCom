...
## File Information
- **File**: `PRH - Guided formation package in YTJ service _ PRH.md`
...
- **Output File**: `processed_docs/PRH___Guided_formation_package_in_YTJ_service___PRH_processed.json`
