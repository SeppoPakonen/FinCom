...
## File Information
- **File**: `PRH - Developing digital financial statement reporting _ PRH.md`
- **Source Directory**: `/common/active/sblo/Dev/FinCom/docs/financial_planning`
- **Status**: COMPLETED
...
- **Output File**: `processed_docs/PRH___Developing_digital_financial_statement_reporting___PRH_processed.json`
