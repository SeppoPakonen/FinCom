...
## File Information
- **File**: `PRH - Publishing documents in other languages than Finnish or Swedish _ PRH.md`
- **Source Directory**: `/common/active/sblo/Dev/FinCom/docs/business_forms_templates`
- **Status**: COMPLETED
...
- **Output File**: `processed_docs/PRH___Publishing_documents_in_other_languages_than_Finnish_or_Swedish___PRH_processed.json`
- **Keywords Extracted**: 11
