...
## File Information
- **File**: `PRH - Osakeyhtiö ja osuuskunta_ Tilinpäätös kaupparekisteristä poiston uhalla _ PRH.md`
- **Source Directory**: `/common/active/sblo/Dev/FinCom/docs/financial_planning_budgets`
- **Status**: COMPLETED
...
- **Output File**: `processed_docs/PRH___Osakeyhtiö_ja_osuuskunta__Tilinpäätös_kaupparekisteristä_poiston_uhalla___PRH_processed.json`
- **Keywords Extracted**: 14
- **Entities Identified**: 1
- **Components Identified**: 1
- **Systems Identified**: 1
- **Constraints Extracted**: 1
- **Metadata Added**: Yes
