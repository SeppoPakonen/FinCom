...
## File Information
- **File**: `Shareholders Meeting Minutes Extraordinary.md`
...
- **Output File**: `processed_docs/Shareholders_Meeting_Minutes_Extraordinary_processed.json`
- **Keywords Extracted**: 7
