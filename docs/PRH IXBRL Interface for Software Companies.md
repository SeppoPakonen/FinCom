...
This guide is intended for companies developing financial management software that want to connect their software to PRH's financial statements interface.
...
* Estimated workload: Approximately 10–15 person-days.
* **Price:** Using the interface is free of charge.
